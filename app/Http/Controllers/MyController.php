...
class MyController extends Controller
{
    ...
    public function dataMasukBuku()
    {
        if (session('id') > 0) {
            ...
            echo view('header');
            echo view('menu');
            echo view('databukumasuk', compact('data'));
            echo view('footer');
        } else {
            echo view('404');
        }
    ...
    public function peminjaman()
    {
        if (session('id') > 0) {
            ...
            echo view('header');
            echo view('menu');
            echo view('datapeminjamanbuku', compact('data'));
            echo view('footer');
        } else {
            echo view('404');
        }
    ...
    public function dataUser()
    {
        if (session('id') > 0) {
            ...
            echo view('header');
            echo view('menu');
            echo view('datauser', compact('users'));
            echo view('footer');
        } else {
            echo view('404');
        }
    ...
    public function updateUser(Request $request, $id)
    {
        ...
        return redirect('/datauser')->with('success','User updated!');
    }
